...
export default function HomeAchievements() {
  return (
    <section className="w-full mb-20">
      ...
      <div className="mt-20 bg-highlight overflow-hidden py-2 flex w-full">
        <motion.div 
          animate={{ x: ["0%", "-50%"] }}
        ...
        >
          {/* First set */}
          <span className="flex items-center text-xs gap-2">Sistech</span>
          <span className="flex items-center text-xs gap-2">Quality</span>
          <span className="flex items-center text-xs gap-2">himti.</span>
          <span className="flex items-center text-xs gap-2">Jakarta.</span>
          <span className="flex items-center text-xs gap-2 italic">brew</span>
          <span className="flex items-center text-xs gap-2">beans</span>
          <span className="flex items-center text-xs gap-2">Coffee</span>
