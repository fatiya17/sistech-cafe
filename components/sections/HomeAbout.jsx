...
export default function HomeAbout() {
  ...
  return (
    <section ref={containerRef} className="w-full py-12 md:py-20 px-8 md:px-12 max-w-[1000px] mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
        ...
        <div className="bento-item bg-[#f2d5e6] dark:bg-primary/20 rounded-md p-8 flex flex-col items-center justify-center relative overflow-hidden group">
