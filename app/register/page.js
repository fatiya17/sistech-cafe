    ...
    <main className="min-h-screen pt-20 md:pt-12 pb-12 px-6 flex items-start justify-center gradient-hero ">
      <div className="container-form w-full flex flex-col p-4 md:p-8">
        <div className="text-center mb-12 md:mb-16">
          <h1 className="font-heading text-3xl md:text-5xl font-bold text-text-primary  mb-2 tracking-tight">Create Account</h1>
          <p className="text-text-body  text-sm md:text-base">Join Sistech Cafe today</p>
        </div>
