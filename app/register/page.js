    ...
    <main className="min-h-screen pt-20 md:pt-12 pb-12 px-6 flex items-start justify-center gradient-hero dark:bg-none">
      <div className="container-form w-full flex flex-col p-4 md:p-8">
        <div className="text-center mb-12 md:mb-16">
          <h1 className="font-heading text-3xl md:text-5xl font-bold text-text-primary dark:text-white mb-2 tracking-tight">Create Account</h1>
          <p className="text-text-body dark:text-text-muted text-sm md:text-base">Join Sistech Cafe today</p>
        </div>

        <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
          <div className="space-y-2">
            <label className="text-sm font-medium text-text-primary dark:text-white">Full Name</label>
            <input 
              type="text" 
